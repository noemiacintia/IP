'''Dadas duas lista a e b, com n e m elementos respectivamente, mostrar a quantidade de elementos de b que estão também em a.
...
Para a entrada n=7, m=5, e as listas a=[22,11,10,8,12,76,50] e b=[5,9,76,20,21], lidos de forma semelhante ao exemplo anterior.
